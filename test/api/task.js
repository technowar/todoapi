...
Lab.describe('`Routes` Test', function () {
	...
	Lab.describe('invalid route', function () {
	...
	Lab.describe('POST /tasks', function () {
	...
	Lab.describe('PUT /tasks', function () {
	...
	Lab.describe('GET /tasks', function () {
	...
	Lab.describe('DELETE /tasks', function () {
